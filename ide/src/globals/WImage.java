...
public class WImage extends Globals {
	...
	public void addMethods(final KawaWrap kawa) throws Throwable {
			...
			public Object apply3(Object r, Object g, Object b) throws Throwable {
				...
				if (r instanceof IntNum)
					...
					throw new IllegalArgumentException(
							"Error in color: red value " + r
									+ " is not an integer.");

				if (g instanceof IntNum)
					gv = ((IntNum) g).ival;
					...
					throw new IllegalArgumentException(
							"Error in color: green value " + g
									+ " is not an integer.");

				if (b instanceof IntNum)
					bv = ((IntNum) b).ival;
					...
					throw new IllegalArgumentException(
							"Error in color: blue value " + b
									+ " is not an integer.");

				if (rv < 0 || rv > 255)
					throw new IllegalArgumentException(
							"Error in color: red value " + rv
									+ " is not in the range [0-255].");
				if (gv < 0 || gv > 255)
					throw new IllegalArgumentException(
							"Error in color: green value " + gv
									+ " is not in the range [0-255].");
				if (bv < 0 || bv > 255)
					throw new IllegalArgumentException(
							"Error in color: blue value " + bv
									+ " is not in the range [0-255].");
		...
		kawa.bind(new Procedure2("color-ref") {
			public Object apply2(Object p, Object b) throws Throwable {
				if (!(p instanceof Color))
					throw new IllegalArgumentException("Error in color-ref: "
							+ p + " is not a color.");
				if (!(b instanceof Symbol))
					throw new IllegalArgumentException("Error in color-ref: "
							+ b + " must be 'red, 'green, or 'blue.");
		...
		kawa.bind(new Procedure1("image-rows") {
			public Object apply1(Object img) throws Throwable {
				if (!(img instanceof ImageShell))
					throw new IllegalArgumentException("Error in image-rows: "
							+ img + " is not an image.");
		...
		kawa.bind(new Procedure1("image-cols") {
			public Object apply1(Object img) throws Throwable {
				if (!(img instanceof ImageShell))
					throw new IllegalArgumentException("Error in image-cols: "
							+ img + " is not an image.");
		...
		kawa.bind(new Procedure3("image-ref") {
			public Object apply3(Object img, Object r, Object c)
					throws Throwable {
				if (!(img instanceof ImageShell))
					throw new IllegalArgumentException("Error in image-ref: "
							+ img + " is not an image.");
				...
				if (r instanceof IntNum)
					...
					throw new IllegalArgumentException(
							"Error in image-ref: row index " + r
									+ " is not an integer.");

				if (c instanceof IntNum)
					cv = ((IntNum) c).ival;
					...
					throw new IllegalArgumentException(
							"Error in image-ref: column index " + c
									+ " is not an integer.");
		...
		// Set a pixel in an image (converts it internally to a writable image
		// if it isn't already).
		kawa.bind(new Procedure4("image-set!") {
			public Object apply4(Object img, Object r, Object c, Object p)
					throws Throwable {
				if (!(img instanceof ImageShell))
					throw new IllegalArgumentException("Error in image-set!: "
							+ img + " is not an image.");
				if (!(p instanceof Color))
					throw new IllegalArgumentException("Error in image-set!: "
							+ img + " is not a color.");
				...
				if (c instanceof IntNum)
					...
					throw new IllegalArgumentException(
							"Error in image-ref: column index " + r
									+ " is not an integer.");
		...
		kawa.bind(new Procedure0or1("read-image") {
			public Object apply0() throws Throwable {
				...
				FileDialog fc = new FileDialog(main, "read-image",
						FileDialog.LOAD);
				fc.setVisible(true);

				if (fc.getFile() == null)
					throw new IllegalArgumentException(
							"Error in read-image: no image chosen.");

				File file = new File(fc.getDirectory(), fc.getFile());
				if (!file.exists())
					throw new IllegalArgumentException(
							"Error in read-image: unable to read image '"
			...
			public Object apply1(Object filename) throws Throwable {
				if (!(filename instanceof String))
					throw new IllegalArgumentException("Error in read-image: "
		...
		kawa.bind(new Procedure1or2("write-image") {
			public Object apply1(Object img) throws Throwable {
				if (!(img instanceof ImageShell))
					throw new IllegalArgumentException("Error in write-image: "
							+ img + " is not an image.");
				...
				FileDialog fc = new FileDialog(main, "write-image",
						FileDialog.LOAD);
				fc.setVisible(true);

				if (fc.getFile() == null)
					throw new IllegalArgumentException(
							"Error in write-image: no file chosen.");
				...
				BufferedImage image = new BufferedImage(i.Width, i.Height,
						BufferedImage.TYPE_INT_RGB);
				WritableRaster raster = (WritableRaster) image.getData();
				for (int r = 0; r < i.Height; r++)
					for (int c = 0; c < i.Width; c++)
						raster.setPixel(c, r, new int[] {
								i.Data[r][c].getRed(), i.Data[r][c].getGreen(),
								i.Data[r][c].getBlue() });
				image.setData(raster);
				ImageIO.write(image,
						FileAccess.extension(outputFile.getName()), outputFile);
		...
		kawa.bind(new Procedure1("draw-image") {
			public Object apply1(Object img) throws Throwable {
				if (!(img instanceof ImageShell))
					throw new IllegalArgumentException("Error in draw-image: "
							+ img + " is not an image.");
		...
		kawa.bind(new Procedure2("image-map") {
			public Object apply2(Object proc, Object img) throws Throwable {
				if (!(img instanceof ImageShell))
					throw new IllegalArgumentException("Error in image-map: "
							+ img + " is not an image.");
		...
		// Create a new image of a given size, using either a color or (lambda
		// (int int int int) ...).
		kawa.bind(new Procedure3("$make-image$") {
			public Object apply3(Object rows, Object cols, Object proc)
					throws Throwable {
				if (!(proc instanceof ModuleMethod || proc instanceof Color))
					throw new IllegalArgumentException("Error in make-image: "
							+ proc + " is neither a color or a procedure.");

				int rowsv, colsv;

				if (rows instanceof IntNum)
					rowsv = ((IntNum) rows).ival;
				else if (rows instanceof Integer)
					rowsv = (Integer) rows;
				else if (rows instanceof Long)
					rowsv = ((Long) rows).intValue();
				else
					throw new IllegalArgumentException(
							"Error in make-image: number of rows " + rows
									+ " is not an integer.");

				if (cols instanceof IntNum)
					colsv = ((IntNum) cols).ival;
				else if (cols instanceof Integer)
					colsv = (Integer) cols;
				else if (cols instanceof Long)
					colsv = ((Long) cols).intValue();
				else
					throw new IllegalArgumentException(
							"Error in make-image: number of columns " + cols
									+ " is not an integer.");
				...
				for (int r = 0; r < rowsv; r++)
					for (int c = 0; c < colsv; c++)
						if (is_proc)
							o.Data[r][c] = (Color) (procv.apply4(r, c, rowsv,
									colsv));
						else
							o.Data[r][c] = procc;
